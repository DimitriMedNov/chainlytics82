        ...
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 via-purple-600 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                {coin.symbol.charAt(0)}
              </div>
              <div>
                <h2 className="text-3xl font-bold text-foreground">{coin.name}</h2>
                <div className="flex items-center gap-2">
                  <p className="text-lg text-muted-foreground font-medium">{coin.symbol}</p>
                  <Badge variant="outline" className="text-sm">#{coin.rank}</Badge>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <p className="text-sm text-muted-foreground font-medium">Precio Actual</p>
              <p className="text-4xl font-bold text-foreground">{formatCurrency(coin.price)}</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">Máximo 24h</p>
                <p className="text-xl font-bold text-green-600">{formatCurrency(additionalData.high24h)}</p>
              </div>
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">Mínimo 24h</p>
                <p className="text-xl font-bold text-red-600">{formatCurrency(additionalData.low24h)}</p>
              </div>
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">Máximo Histórico</p>
                <p className="text-lg font-semibold text-amber-600">{formatCurrency(additionalData.ath)}</p>
              </div>
              <div className="space-y-2">
                <p className="text-sm text-muted-foreground">Mínimo Histórico</p>
                <p className="text-lg font-semibold text-slate-600">{formatCurrency(additionalData.atl)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 border rounded-xl bg-gradient-to-br from-background to-muted/20">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold">Gráfico de Precios (30 días)</h3>
            </div>
          ...
          {/* Market Stats */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 border rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900">
              <div className="flex items-center gap-3 mb-4">
                <BarChart3 className="h-6 w-6 text-blue-600" />
                <h3 className="text-lg font-semibold">Capitalización de Mercado</h3>
              </div>
              <p className="text-3xl font-bold text-blue-700 dark:text-blue-300 mb-2">{formatNumber(coin.marketCap)}</p>
            ...
            <div className="p-6 border rounded-xl bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900">
              <div className="flex items-center gap-3 mb-4">
                <DollarSign className="h-6 w-6 text-green-600" />
                <h3 className="text-lg font-semibold">Volumen e Oferta</h3>
              </div>
              <p className="text-3xl font-bold text-green-700 dark:text-green-300 mb-2">{formatNumber(coin.volume)}</p>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="outline" className="capitalize font-medium">{coin.category}</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Símbolo:</span>
                  <span className="font-medium text-lg">{coin.symbol}</span>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-green-600 font-medium text-sm">En vivo</span>
                  </div>
                </div>
              </div>
            </div>
