...
const WatchlistItem = ({ 
  ...
  return (
    <div className={`flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-5 lg:p-6 border rounded-2xl ${hoverClass} transition-all duration-300 hover:shadow-lg hover:scale-[1.02] bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-gray-200 dark:border-gray-700 gap-4 sm:gap-0`}>
      ...
      <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-4 lg:gap-6">
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            className={`h-8 w-8 rounded-xl hover:scale-110 transition-all duration-200 ${
              item.isFavorite 
          ...
          <Button
            ...
            className="text-blue-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 h-8 w-8 rounded-xl hover:scale-110 transition-all duration-200"
          >
          ...
          <Button
            ...
            className="text-emerald-500 hover:text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 h-8 w-8 rounded-xl hover:scale-110 transition-all duration-200"
          >
          ...
          <Button
            ...
            className="text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 h-8 w-8 rounded-xl hover:scale-110 transition-all duration-200"
          >
